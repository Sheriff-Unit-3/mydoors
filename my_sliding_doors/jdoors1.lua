...
local doors = {
	{
		"my_sliding_doors:door1a",
		"my_sliding_doors:door1b",
		"my_sliding_doors:door1c",
		"my_sliding_doors:door1d",
		"1",
		"White",
	},
	{
		"my_sliding_doors:door2a",
		"my_sliding_doors:door2b",
		"my_sliding_doors:door2c",
		"my_sliding_doors:door2d",
		"2",
		"Flower",
	},
	{
		"my_sliding_doors:door3a",
		"my_sliding_doors:door3b",
		"my_sliding_doors:door3c",
		"my_sliding_doors:door3d",
		"3",
		"Framed",
	},
}
...
local function add_door(doora, doorb, doorc, doord, num, des)
	local function onplace(itemstack, placer, pointed_thing)
		...
		if
			not core.registered_nodes[core.get_node(pos).name].buildable_to
			or not core.registered_nodes[core.get_node(above).name].buildable_to
		then
	...
	core.register_node("my_sliding_doors:jpanel" .. num, {
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			if
				not core.registered_nodes[core.get_node(pos).name].buildable_to
				or not core.registered_nodes[na.name].buildable_to
			then
				core.chat_send_player(placer:get_player_name(), "Not enough room")
				return
			end
