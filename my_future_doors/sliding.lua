...
local doors = {
	{
		...
		"my_future_doors:door2b",
		"my_future_doors:door2c",
		"my_future_doors:door2d",
		"2",
		"Steel",
		{
	...
	},
	{
		...
		"my_future_doors:door3b",
		"my_future_doors:door3c",
		"my_future_doors:door3d",
		"3",
		"Squared",
		{
			{ "default:steel_ingot", "default:steel_ingot", "" },
	...
	},
	{
		...
		"my_future_doors:door4b",
		"my_future_doors:door4c",
		"my_future_doors:door4d",
		"4",
		"Dark",
		{
			{ "default:steel_ingot", "default:steel_ingot", "" },
	...
	},
	{
		...
		"my_future_doors:door6b",
		"my_future_doors:door6c",
		"my_future_doors:door6d",
		"6",
		"Points",
		{
			{ "default:steel_ingot", "default:steel_ingot", "" },
	...
	},
	{
		...
		"my_future_doors:door7b",
		"my_future_doors:door7c",
		"my_future_doors:door7d",
		"7",
		"Snow Flake",
		{
			{ "default:steel_ingot", "default:steelblock", "" },
	...
	{
		"my_future_doors:door8a",
		"my_future_doors:door8b",
		"my_future_doors:door8c",
		"my_future_doors:door8d",
		"8",
		"Blue Steel",
		{
			{ "default:steel_ingot", "default:steelblock", "" },
	...
	{
		"my_future_doors:door9a",
		"my_future_doors:door9b",
		"my_future_doors:door9c",
		"my_future_doors:door9d",
		"9",
		"Tan Steel",
		{
			{ "default:steel_ingot", "default:steelblock", "" },
...
local function add_door(doora, doorb, doorc, doord, num, des, recipe)
	local function onplace(itemstack, placer, pointed_thing)
		...
		if
			not core.registered_nodes[core.get_node(pos1).name].buildable_to
			or not core.registered_nodes[core.get_node(pos2).name].buildable_to
		then
	...
	local function rightclick(pos, node, player, itemstack, pointed_thing)
		...
		for i = 0, 3 do
			...
			if neighbour.name == "my_misc_doors:door2a" then
				...
				core.set_node(
					vector.add(neighbour_pos, { x = 0, y = 1, z = 0 }),
					{ name = doord, param2 = neighbour.param2 }
				)
			end
		end
	...
	local function ontimer(pos, elapsed)
		...
		for i = 0, 3 do
			...
			if neighbour.name == "my_misc_doors:door2c" then
				...
				core.set_node(
					vector.add(neighbour_pos, { x = 0, y = 1, z = 0 }),
					{ name = doorb, param2 = neighbour.param2 }
				)
			end
		end
	end
